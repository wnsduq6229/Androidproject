...
public class tip_math_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tip_math);
        ...
        hand.postDelayed(new Runnable() {
            @Override
            public void run(){
                Intent i=new Intent(tip_math_Activity.this, Title2_2Activity.class);
                startActivity(i);
                finish();
            }
        }, 5000);
