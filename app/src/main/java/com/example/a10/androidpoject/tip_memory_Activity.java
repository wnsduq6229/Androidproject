...
public class tip_memory_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tip_memory);
        ...
        hand.postDelayed(new Runnable() {
            @Override
            public void run(){
                Intent i=new Intent(tip_memory_Activity.this, Title2_2Activity.class);
                startActivity(i);
                finish();
            }
        }, 5000);
